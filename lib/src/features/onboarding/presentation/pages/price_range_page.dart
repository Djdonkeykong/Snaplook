...
import 'category_interests_page.dart';

class PriceRangePage extends ConsumerStatefulWidget {
  const PriceRangePage({super.key});

  @override
  ConsumerState<PriceRangePage> createState() => _PriceRangePageState();
}
...
class _PriceRangePageState extends ConsumerState<PriceRangePage>
  ...
  void initState() {
    ...
    _animationControllers = List.generate(_priceOptions.length, (index) {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedPrice = ref.watch(priceRangeProvider);
