...
class _SafariTutorialPageState extends ConsumerState<SafariTutorialPage> {
  ...
  String _getInstructionText(SafariTutorialStep step) {
    switch (step) {
      ...
      case SafariTutorialStep.tapDone:
        return "Tap 'Done'.";
      case SafariTutorialStep.tapDoneLast:
  ...
  Widget build(BuildContext context) {
    ...
    const step2PopupAsset = 'assets/images/instagram_step2_popup_android.png';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (hasUserTapped &&
              ((_isAndroid && currentStep == SafariTutorialStep.step2) ||
