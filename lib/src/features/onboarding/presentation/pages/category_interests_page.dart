...
import 'shopping_frequency_page.dart';

class CategoryInterestsPage extends ConsumerStatefulWidget {
...
class _CategoryInterestsPageState extends ConsumerState<CategoryInterestsPage>
  ...
  void initState() {
    ...
    _animationControllers = List.generate(_categoryOptions.length, (index) {
            ...
            onPressed: selectedCategories.isEmpty
                ...
                : () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => const ShoppingFrequencyPage(),
                      ),
                    );
                  },
