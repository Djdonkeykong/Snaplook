...
class AgeRangePage extends ConsumerStatefulWidget {
  const AgeRangePage({super.key});

  @override
  ConsumerState<AgeRangePage> createState() => _AgeRangePageState();
}
...
class _AgeRangePageState extends ConsumerState<AgeRangePage>
  ...
  void initState() {
    ...
    _animationControllers = List.generate(_ageOptions.length, (index) {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedAge = ref.watch(ageRangeProvider);
