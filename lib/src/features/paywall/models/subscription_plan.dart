...
class SubscriptionPlan {
  ...
  static const monthly = SubscriptionPlan(
    id: 'monthly',
    name: 'Monthly',
    productId: 'snaplook_monthly_subscription', // Update with your RevenueCat product ID
    price: 7.99,
    priceString: '\$7.99/mo',
  ...
  static const yearly = SubscriptionPlan(
    id: 'yearly',
    name: 'Yearly',
    productId: 'snaplook_yearly_subscription', // Update with your RevenueCat product ID
    price: 59.99,
    priceString: '\$4.99/mo',
